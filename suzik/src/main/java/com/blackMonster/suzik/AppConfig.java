...
public class AppConfig {
	...
	public static final String MAIN_URL = "http://suzik.elasticbeanstalk.com/music1/reciver.php";
	public static final String FLAG_URL = "http://suzik.elasticbeanstalk.com/music1/songLink/flagSong.php";
