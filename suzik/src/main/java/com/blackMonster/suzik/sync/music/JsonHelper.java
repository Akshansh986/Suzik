...
class JsonHelper {
    ...
    public static class InappSong {

        private static final String P_SONGS_ARRAY = "songsData";
        private static final String P_MODULE = "music";
        private static final String P_CMD_VALUE = "addInAppDownloaded";

        private static final String P_FINGERPRINT = "fp";
        private static final String P_ID = "id";

        private static final String P_R_STATUS = "status";
        private static final String P_R_RESULT = "result";
        private static final String P_R_ID = "id";

        private static final int STATUS_OK = 1;


        public static JSONObject toJson(long id, String fp) throws JSONException {
            JSONObject root = new JSONObject();
            JSONArray songArray = new JSONArray();

            songArray.put(getSingleObject(id, fp));
        ...
        private static JSONObject getSingleObject(long id, String fp)
                throws JSONException {

            JSONObject obj = new JSONObject();
            obj.put(P_FINGERPRINT, fp);
            obj.put(P_ID, id);
            return obj;
        ...
        public static boolean parseResponse(JSONObject response)
            ...
            JSONArray responseArray = response.getJSONArray(P_R_RESULT);
            JSONObject obj = (JSONObject) responseArray.get(0);
            return obj.getInt(P_R_STATUS) == 1;
        }
